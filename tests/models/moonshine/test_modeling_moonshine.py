...
def _moonshine_initialize_config_kwargs(
    self,
    vocab_size: int,
...
def _moonshine_get_rotary_ndims(self, config: PretrainedConfig) -> int:
    return config.hidden_size // config.decoder_num_attention_heads


@require_torch
class MoonshineModelTest(
    ...
    initialize_config_kwargs = _moonshine_initialize_config_kwargs
    get_rotary_ndims = _moonshine_get_rotary_ndims
